...
def build_args():
    ...
    # ---------------- 数据集与路径配置 ----------------
    p.add_argument("--dataset", type=str, default="cora", help="数据集名称 (cora, citeseer, pubmed, acm, chameleon, bat, amap, amazon_electronics_photo, amazon_electronics_computers)")
